...
let config_options =
    ...
    [ (* align_symbol_open_paren *)
      make_option_updater "align_symbol_open_paren" bool_values (fun conf v ->
        { conf with
          fmt_opts = { conf.fmt_opts with align_symbol_open_paren = elt v }
        } );
      (* assignment_operator *)
      make_option_updater
        "assignment_operator"
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with assignment_operator = elt v }
           } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts =
               { conf.fmt_opts with break_around_multiline_strings = elt v }
           } );
      (* break_before_in *)
      make_option_updater
        "break_before_in"
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with break_before_in = elt v }
           } );
      (* break_cases *)
      make_option_updater
        "break_cases"
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with break_cases = elt v } } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts =
               { conf.fmt_opts with break_collection_expressions = elt v }
           } );
      (* break_colon *)
      make_option_updater
        "break_colon"
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with break_colon = elt v } } );
      (* break_infix *)
      make_option_updater
        "break_infix"
        [ ("wrap", `Wrap);
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with break_infix = elt v } } );
      (* break_infix_before_func *)
      make_option_updater "break_infix_before_func" bool_values (fun conf v ->
        { conf with
          fmt_opts = { conf.fmt_opts with break_infix_before_func = elt v }
        } );
      (* break_fun_decl *)
      make_option_updater
        "break_fun_decl"
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with break_fun_decl = elt v }
           } );
      (* break_fun_sig *)
      make_option_updater
        "break_fun_sig"
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with break_separators = elt v }
           } );
      (* break_sequences *)
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with break_string_literals = elt v }
           } );
      (* break_struct *)
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with cases_matching_exp_indent = elt v }
           } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts =
               { conf.fmt_opts with disambiguate_non_breaking_match = elt v }
           } );
      (* doc_comments *)
      make_option_updater
        "doc_comments"
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with doc_comments = elt v } } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with doc_comments_tag_only = elt v }
           } );
      (* dock_collection_brackets *)
      make_option_updater "dock_collection_brackets" bool_values (fun conf v ->
        { conf with
          fmt_opts = { conf.fmt_opts with dock_collection_brackets = elt v }
        } );
      (* exp_grouping *)
      make_option_updater
        "exp_grouping"
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with exp_grouping = elt v } } );
      (* field_space *)
      make_option_updater
        "field_space"
        [ ("tight", `Tight); ("loose", `Loose); ("tight_decl", `Tight_decl) ]
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with field_space = elt v } } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with function_indent_nested = elt v }
           } );
      (* if_then_else *)
      make_option_updater
        "if_then_else"
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with if_then_else = elt v } } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts =
               { conf.fmt_opts with indicate_multiline_delimiters = elt v }
           } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts =
               { conf.fmt_opts with indicate_nested_or_patterns = elt v }
           } );
      (* infix_precedence *)
      make_option_updater
        "infix_precedence"
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with infix_precedence = elt v }
           } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts =
               { conf.fmt_opts with leading_nested_match_parens = elt v }
           } );
      (* let_and *)
      make_option_updater
        "let_and"
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with let_and = elt v } } );
      (* let_binding_deindent_fun *)
      make_option_updater "let_binding_deindent_fun" bool_values (fun conf v ->
        { conf with
          fmt_opts = { conf.fmt_opts with let_binding_deindent_fun = elt v }
        } );
      (* let_binding_spacing *)
      make_option_updater
        "let_binding_spacing"
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with let_binding_spacing = elt v }
           } );
      (* let_module *)
      make_option_updater
        "let_module"
      ...
      make_option_updater
        ...
        [ ("lf", `Lf); ("crlf", `Crlf) ]
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with line_endings = elt v } } );
      (* match_indent_nested *)
      make_option_updater
        "match_indent_nested"
        [ ("always", `Always); ("auto", `Auto); ("never", `Never) ]
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with match_indent_nested = elt v }
           } );
      (* module_item_spacing *)
      make_option_updater
        "module_item_spacing"
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with module_item_spacing = elt v }
           } );
      (* nested_match *)
      make_option_updater
        "nested_match"
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with nested_match = elt v } } );
      (* ocp_indent_compat *)
      make_option_updater "ocp_indent_compat" bool_values (fun conf v ->
        { conf with
          fmt_opts = { conf.fmt_opts with ocp_indent_compat = elt v }
        } );
      (* parens_ite *)
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with parens_tuple = elt v } } );
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with parens_tuple_patterns = elt v }
           } );
      (* parse_docstrings *)
      ...
      make_option_updater
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with sequence_blank_line = elt v }
           } );
      (* sequence_style *)
      make_option_updater
        "sequence_style"
        ...
        (fun conf v ->
           { conf with
             fmt_opts = { conf.fmt_opts with sequence_style = elt v }
           } );
      (* single_case *)
      make_option_updater
        "single_case"
      ...
      make_option_updater
        ...
        [ ("compact", `Compact); ("sparse", `Sparse) ]
        (fun conf v ->
           { conf with fmt_opts = { conf.fmt_opts with type_decl = elt v } } );
      (* wrap_comments *)
...
let parse_config (list : Js.js_string Js.t matrix_js_t) =
    let list =
        Js.to_array list
        |> Array.map (fun row -> Js.to_array row |> Array.map Js.to_string)
    in
    list
    |> Array.to_seq
